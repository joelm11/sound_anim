...
void main()
{
    ...
    float decayRate = 10.0; // Controls how quickly the displacement decays with distance
    float waveWidth = 0.8; // Controls the width of the wave's influence zone
    ...
    float angleFromOrigin = acos(dot(normalize(basePosition), normalize(waveOrigin)));
